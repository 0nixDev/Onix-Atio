...
def setTitle(_str):
    system = os.name
    if system == 'nt':
        ctypes.windll.kernel32.SetConsoleTitleW(f"{_str} - Made By Onix")
    elif system == 'posix':
        sys.stdout.write(f"\x1b]0;{_str} - Made By Onix\x07")
    else:
        pass
...
def discserver():
    print(f"""{y}------------------------------------------------------------------------------------------------------------------------\n{w}raadev {b}|{w} https://dsc.gg/onixdev {b}|{w} https://github.com/0nixDev {b}|{w} https://dsc.gg/onixdev {b}|{w} https://dsc.gg/onixdev {b}|{w} https://di\n{y}------------------------------------------------------------------------------------------------------------------------\n""")
